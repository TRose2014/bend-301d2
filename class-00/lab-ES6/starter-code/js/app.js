...
function displayPics(){
  ...
  // rando is a local variable in the function displayPics. Since rando is a const variable it is only limited inside the displayPics function and not outside. If the console.log was inside the displayPics function then it will work.
  console.log(viewed);
